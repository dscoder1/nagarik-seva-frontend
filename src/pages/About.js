        ...
        <div className="about-grid">
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: '1rem' }}>
              NagarikSeva was built as a final year project with a real-world mission: to give ordinary citizens a powerful, transparent tool to report civic issues and ensure they are actually resolved.
            </p>
